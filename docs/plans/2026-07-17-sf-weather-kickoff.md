# San Francisco weather lookup — worker kickoff

## Objective

Get the current weather in San Francisco, California for the user and return a concise, factual report.

## Instructions

- Treat “SF” as San Francisco, California.
...
Emit the weather report as the task result with source-backed, current values for San Francisco, CA.
