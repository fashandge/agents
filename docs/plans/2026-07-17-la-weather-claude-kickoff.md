# Los Angeles weather lookup — worker kickoff

## Objective

Get the current weather in Los Angeles, California for the user and return a concise, factual report.

## Instructions

- Treat “LA” as Los Angeles, California, United States.
...
Emit the weather report as the task result with source-backed, current values for Los Angeles, CA.
