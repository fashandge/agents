# Seattle weather lookup — worker kickoff

## Objective

Get the current weather in Seattle, Washington for the user and return a concise, factual report.

## Instructions

- Treat “Seattle” as Seattle, Washington, United States.
...
Emit the weather report as the task result with source-backed, current values for Seattle, WA.
